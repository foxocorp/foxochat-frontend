...
const MessageListComponent = ({
    ...
    const messages = useMemo(() => {
        ...
        Logger.debug("Messages from appStore:", storeMessages, "channelId:", channel.id);
    ...
    const isInitialLoading = propIsInitialLoading || appStore.loadingInitial.has(channel.id);
    ...
    useEffect(() => {
        ...
        if (!messages || messages.length === 0) {
            ...
            if (!appStore.activeRequests.has(channel.id)) {
                ...
                appStore.initChannel(channel.id).catch((error) =>
