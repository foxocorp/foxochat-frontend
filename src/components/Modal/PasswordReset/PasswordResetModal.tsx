...
export const PasswordResetModal = ({
    ...
    return (
        <div className={`${style.overlay} ${isOpen ? style.visible : ""}`} onClick={onClose}>
            <div className={style.modal} onClick={(e) => { e.stopPropagation(); }}>
                {state.step === 1 && (
                    <>
                        <h2 className={style.title}>Reset password</h2>
                        <p className={style.description}>Type your email to reset password</p>
                        <input
                            type="email"
                ...
                {state.step === 3 && (
                    <>
                        ...
                        <p className={style.description}>This will replace your old password</p>
                        <input
                            type="password"
